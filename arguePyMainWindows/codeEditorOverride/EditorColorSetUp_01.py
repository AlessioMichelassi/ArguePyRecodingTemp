...
from arguePyMainWindows.codeEditorOverride.lineNumberWidget import LineNumberArea
...
class EditorColorSetUp(QPlainTextEdit):
    ...
    def setFontAndColor(self, dictionary):
        ...
        """self.setCaretColor(self.configFontAndColor["caretColor"])
        self.setCaretBackgroundColor(self.configFontAndColor["caretBackgroundColor"])
        self.setSelectionColor(self.configFontAndColor["selectionColor"])
        self.setSelectionBackgroundColor(self.configFontAndColor["selectionBackgroundColor"])
        self.setIndentationLineColor(self.configFontAndColor["indentationLineColor"])
        self.setIndentationLineWidth(self.configFontAndColor["indentationLineWidth"])
        self.setIndentationWidth(self.configFontAndColor["indentationWidth"])
        self.setMarginColor(self.configFontAndColor["marginColor"])
        self.setMarginTextColor(self.configFontAndColor["marginTextColor"])
        self.setMarginBackgroundColor(self.configFontAndColor["marginBackgroundColor"])"""
