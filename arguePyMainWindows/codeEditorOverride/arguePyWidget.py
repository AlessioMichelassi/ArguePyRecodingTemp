...
from arguePyMainWindows.codeEditorOverride.EditorCodeMain import codeEditor
from arguePyMainWindows.codeEditorOverride.searchAndReplaceWidget import searchAndReplaceWidget
